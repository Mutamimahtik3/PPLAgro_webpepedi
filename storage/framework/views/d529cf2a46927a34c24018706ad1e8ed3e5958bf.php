...
<div class="card mb-4">
    <div class="card-body">
        <div class="table-responsive">
            <form action="<?php echo e(route('a.konsultan.update', ['id' => $data->id])); ?>" method="POST">
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ppl-agro-main\ppl-agro-main\resources\views/admin/konsultan/edit.blade.php ENDPATH**/ ?>