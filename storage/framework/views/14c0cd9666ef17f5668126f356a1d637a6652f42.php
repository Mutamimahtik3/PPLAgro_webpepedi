...
<center>
		<form action="<?php echo e(route('a.i.tn.update', ['id' => $data->id])); ?>" method="POST">
		<?php echo csrf_field(); ?>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ppl-agro-main\ppl-agro-main\resources\views/admin/tanam/jadwal.blade.php ENDPATH**/ ?>