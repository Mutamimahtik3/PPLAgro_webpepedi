...
<center>
	...
	<a href="<?php echo e(route('a.i.tn.edit', ['id' => $data->id])); ?>" class="btn btn-primary">Tambah Rekomendasi</a>
	<br>
	<hr>
	...
	<table class="table table-bordered table-stripped" width="70%" align="center">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<?php echo e(route('a.i.tn.ubah.jadwal', ['id' => $data->id, 'idjadwal' => $jadwal->id])); ?>">Ubah</a>
				</td>
			</tr>
