	...
	<table width="70%" class="table table-bordered table-stripped">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<?php echo e(route('k.i.ps.show', ['id' => $data->id])); ?>">Detail</a>
				</td>
			</tr>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ppl-agro-main\ppl-agro-main\resources\views/konsultan/pascatanam/index.blade.php ENDPATH**/ ?>