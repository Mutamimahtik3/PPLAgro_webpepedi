...
<div class="card mb-4">
    <div class="card-header">
        ...
        <!-- <a href="<?php echo e(route('p.i.in.show.edit', ['id' => $data->id])); ?>" class="btn btn-primary btn-sm">
            Ubah
        </a> -->
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ppl-agro-main\ppl-agro-main\resources\views/petani/tanam/show.blade.php ENDPATH**/ ?>