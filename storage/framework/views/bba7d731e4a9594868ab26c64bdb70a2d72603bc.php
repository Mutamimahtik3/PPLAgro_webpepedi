                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="car box-shadow">
                            <img src="<?php echo e(asset(Storage::url('public/artikel/'.$data->gambar))); ?>" alt="Thumbnail [100%x225]" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" class="card-img-top" style="height: 225px; width: 100%; display: block;" data-holder-rendered="true">
                            <div class="card-body">
                                <p class="card-text">
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ppl-agro-main\resources\views/admin/artikel/index.blade.php ENDPATH**/ ?>