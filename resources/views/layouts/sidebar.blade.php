<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="@if(Request::segment(1)=='admin'){{ route('admin.index') }} @elseif(Request::segment(1)=='peternak'){{ route('peternak.index') }} @elseif(Request::segment(1)=='distributor'){{ route('distributor.index') }}  @endif">PEPEDI</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="@if(Request::segment(1)=='admin'){{ route('admin.index') }} @elseif(Request::segment(1)=='peternak'){{ route('peternak.index') }} @elseif(Request::segment(1)=='distributor'){{ route('distributor.index') }}  @endif">PADI</a>
        </div>
