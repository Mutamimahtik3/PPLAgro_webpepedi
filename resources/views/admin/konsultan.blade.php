    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-hover">
                ...
                <tbody>
                @foreach ($konsultan as $no => $knslt)
                    <tr>
                        <th scope="row">{{ $no+1 }}</th>
                        <td>{{ $kcm->nama_konsultan }}</td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Data Konsultan</h5>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_kecamatan" value="{{ old('nama_konsultan') }}" class="form-control @error('nama_konsultan') is-invalid @enderror" autocomplete="off">
...
<script>
    $(".swal-confirm").click(function(e) {
        ...
        swal({
            title:'Apakan anda yakin menghapus data?',
